$(function() {
  ...
  contact-circle点击效果
   */
  $(document).on('click', '.contact-circle', function() {
    if ($(this).hasClass("contact-circle-change")) {
      $(this).removeClass("contact-circle-change");
      $(this).siblings(".contact-link,.contact-name").removeClass("contact-info-change");
      $(this).parent().removeClass("contact-item-change");
      $('.contact-item').removeClass("contact-item-hidden");
    } else {
      $(this).addClass("contact-circle-change");
      $(this).siblings(".contact-link,.contact-name").addClass("contact-info-change");
      $(this).parent().addClass("contact-item-change");
      $('.contact-item').addClass("contact-item-hidden");
    }
  });
